...
при этом указанные элементы функционально связаны между собой таким образом, что при обмене активами Routing Core инициирует отзыв старых и выпуск новых сертификатов через центр сертификации, обеспечивая атомарный обмен цифровыми активами без использования централизованного реестра и контроль их статуса через публичный репозиторий.
